...
public class GetCitiesTask extends AsyncTask<String, Void, String> {
    ...
    private static String SUFFIX = "&type=like&mode=json&appid=928ba8e8e9c9025abb544ff60b861c2a"; // The API key should really be hidden, but is kept here for the sake of portability/demo-ability
